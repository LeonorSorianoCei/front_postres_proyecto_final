      ...
      <main className="container">
          <section className="welcome-section">
            <div className="hero-content">
              ...
              { isLogged  &&
              <img className='imagen-usuario' src={imagen ? `${VITE_BACKEND_URL_IMG}${datosUsuario.imagen}` : `${VITE_BACKEND_URL_IMG}logo_mundo_de_azucar.png`} alt={datosUsuario.nombre}  />      
              }
            </div>
          </section>
